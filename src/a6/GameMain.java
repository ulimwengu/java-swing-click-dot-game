...
/**
 * Main class for Click-a-Dot game. Creates window with game board, score label,
 * start button, and
...
public class GameMain {
     ...
     * </ul>
     * Window should be disposed when closed, and all game tasks stopped. This
    ...
    private static void createAndShowGUI() {
        ...
        /*
         * Added scorelabel at the top of frame/container.
         */
        ...
        /*
         * Set startButton at the bottom of the Game container/frame
         */
        ...
        /*
         * Added a menu bar with a "File" menu to the frame
         * Attached the menus to the menubar
         */
        ...
        /*
         * Added start button to start the game;
         * Added lambda for Action Event;
         */
        startButton.addActionListener((ActionEvent exception) -> game.startGame());
        ...
        /*
         * Import PropertyChangeEvent from java.beans
         * SEt property to "GameScore"
         * Set label text to "Score"
         */
        game.addPropertyChangeListener("GameScore",
                (PropertyChangeEvent exception) -> scoreLabel.setText("Score: "
                        + game.getScore()));
        ...
        /*
         * Added ChangeListener to `sizeSlider` that sets the game's target radius to
         * the slider's current value;
         * Used lambda for changeListener Event;
         */
        ...
        /*
         * Updted target duration when the speed of slider changes;
         */
        speedSlider.addChangeListener(
                (ChangeListener) 
                -> game.setTargetTimeMillis(speedSlider
                        .getValue()));

        // When "Save" menu item is activated, open file dialog and append score
        // to chosen file.
        saveItem.addActionListener((ActionEvent ae) -> saveScore(frame,
                game.getScore()));
    ...
    /**
     * Label `slider`'s minimum value with `minLabel` and its maximum value with
     * `maxLabel`.
     */
    private static void addSliderLabels(JSlider slider, String minLabel,
        ...
        // TODO 12:
        // 1. Put a mapping in dictionary `labels`. The key for the mapping should be
        // the slider's
        // minimum value, which
        // can be found with `JSlider.getMinimum`. The value for the mapping should be a
        // JLabel
        // with the text from `minLabel`.
        // 2. Put another mapping in the dictionary for the slider's maximum value, with
        // the text
        // from `maxLabel`.
        // 3. Show the labels on the slider using `JSlider.setLabelTable` and
        // `.setPaintLabels`. See
        // the JSlider tutorial [1]
        // for example code that you can adapt. Look under the heading "Customizing
        // Labels on a
        // Slider".
        // [1] https://docs.oracle.com/javase/tutorial/uiswing/components/slider.html

        /*
         * Have Put a mapping in dictionary labels with minimum and maximum values;
         * Have Shown the labels on the slider using `JSlider.setLabelTable` and
         * `.setPaintLabels`
         */
    ...
    /**
     * Place `slider` in a new padded panel with top label `title` and return the
     * panel.
     */
    private static JComponent makeSliderPanel(JSlider slider, String title) {
        // TODO 13:
        // 1. Construct a new JPanel with a BorderLayout manager. See the JPanel
        // tutorial [1] under
        // the
        ...
        // padding on all sides. Use an overload of `BorderFactory.createEmptyBorder`
        // [2] to create
        // the border.
        ...
        // (centered). Set a font size of 16 points. For an example of setting the font
        // size,
        ...
        /*
         * Constructed a new JPanel with a BorderLayout manager;
         * Added an EmptyBorder around the panel to provide at least (4px) of padding on
         * all sides;
         * 
         */
        ...
        JLabel t_Label = new JLabel(title,
                SwingConstants.CENTER);
        t_Label.setFont(t_Label.getFont().deriveFont(16.0f));
        slider.add(t_Label, BorderLayout.NORTH);
        return slider;
    }

    /**
     * Append a line containing `score` to a user-selected file, using `frame` as
     * the parent of any
    ...
    private static void saveScore(JFrame frame, int score) {
        ...
        /*
         * Save file in a dialog;
         * show an exception whenever there is an arror;
         */
